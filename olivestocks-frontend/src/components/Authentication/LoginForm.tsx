        ...
        <div className="flex flex-col md:flex-row">
          ...
          <div className="w-full md:w-1/2 h-[650px] mx-auto flex flex-col items-center justify-center">
            ...
            <div className="mb-6 flex justify-center space-x-4">
              <button onClick={() => signIn("google", { callbackUrl: "/" })} className="flex h-12 w-12 items-center justify-center rounded-full bg-gray-100">
                <Image
              ...
              <button onClick={() => signIn("apple", { callbackUrl: "/" })} className="flex h-12 w-12 items-center justify-center rounded-full bg-gray-100">
                <Image
