            ...
            <ul className="">
              <li className="py-4 border-t border-[#BFBFBF] px-8">
                <div className="flex justify-between otems-center text-sm">
                  ...
                  <span
                    className={`text-xs ${
                      recentActivity.oneMonthReturn >= 0
                        ? "text-green-600"
                        : "text-red-600"
                    } px-2 py-1 rounded-full`}
                  >
                    {recentActivity.oneMonthReturn >= 0 ? "▲" : "▼"}
                    {recentActivity?.oneMonthReturn == null
                      ? "0.00"
                      : recentActivity.oneMonthReturn.toFixed(2)}
                    %
                  </span>
                </div>
              </li>
              <li className="py-4 border-t border-[#BFBFBF] px-8">
                <div className="flex justify-between otems-center text-sm">
                  ...
                  <span
                    className={`text-xs ${
                      recentActivity.sixMonthReturn >= 0
                        ? "text-green-600"
                        : "text-red-600"
                    } px-2 py-1 rounded-full`}
                  >
                    {recentActivity.sixMonthReturn >= 0 ? "▲" : "▼"}
                    {recentActivity?.sixMonthReturn == null
                      ? "0.00"
              ...
              <li className="py-4 border-t border-[#BFBFBF] px-8">
                <div className="flex justify-between otems-center text-sm">
                  ...
                  <span
                    className={`text-xs ${
                      recentActivity.twelveMonthReturn >= 0
                        ? "text-green-600"
                        : "text-red-600"
                    } px-2 py-1 rounded-full`}
                  >
            ...
            <ul className="">
              ...
              <li className="py-4 border-t border-[#BFBFBF] px-8">
                <div className="flex justify-between otems-center text-sm">
                  ...
                  <span className="text-xs flex items-center">
                    <span
                      className={`${
                        portfolioDetails.riskProfile === "Low"
                          ? "text-green-600"
                          : ""
                      }`}
                    >
                    ...
                    <span
                      className={`${
                        portfolioDetails.riskProfile === "Medium"
                          ? "text-[#E6C200]"
                          : ""
                      }`}
                    >
                    ...
                    <span
                      className={`${
                        portfolioDetails.riskProfile === "High"
                          ? "text-red-600"
                          : ""
                      }`}
                    >
              ...
              <li className="py-4 border-t border-[#BFBFBF] px-8">
                <div className="flex justify-between otems-center text-sm">
                  ...
                  <span
                    className={`text-xs ${
                      portfolioDetails.totalReturn >= 0
                        ? "text-green-600"
                        : "text-red-600"
                    } px-2 py-1 rounded-full`}
                  >
          ...
          {isLoadingPortfolioData ? (
            ...
            <ul className="">
              <li className="py-4 border-t border-[#BFBFBF] px-8">
                <div className="flex justify-between otems-center text-sm">
                  <p>Asset</p>
                  <span className="text-xs">{mostProfitableTrade.asset}</span>
                </div>
              </li>
              <li className="py-4 border-t border-[#BFBFBF] px-8">
                <div className="flex justify-between otems-center text-sm">
                  ...
                  <span className="text-xs">
                    {mostProfitableTrade.opened
                      ? new Date(mostProfitableTrade.opened).toLocaleDateString(
                          "en-US",
                          {
                            year: "numeric",
                            month: "short",
              ...
              <li className="py-4 border-t border-[#BFBFBF] px-8">
                <div className="flex justify-between otems-center text-sm">
                  ...
                  <span
                    className={`text-xs ${
                      mostProfitableTrade.gain >= 0
                        ? "text-green-600"
                        : "text-red-600"
                    } px-2 py-1 rounded-full`}
                  >
                    {mostProfitableTrade.gain ? mostProfitableTrade.gain >= 0 ? "▲" : "▼" : ""}
                    {mostProfitableTrade.gain ? `${mostProfitableTrade.gain?.toFixed(2)} %` : ""}
                  </span>
                </div>
              </li>
            </ul>
