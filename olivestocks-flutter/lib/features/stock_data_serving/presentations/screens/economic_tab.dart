...
class EconomicTab extends StatefulWidget {
  const EconomicTab({super.key});

  @override
  State<EconomicTab> createState() => _EconomicTabState();
}

class _EconomicTabState extends State<EconomicTab> {
                        ...
                        child: Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              // Event Details
                              Container(
                                width: ((size.width * .9)/2) -10,
                                child: Column(
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                  children: [
                                    Text(
                                      "Used Car Prices Year-over-Year (Mar)",
                                      style: TextStyle(
                                    ...
                                    Row(
                                      children: [
                                        ...
                                        Text('0.10%',style: TextStyle(fontSize: 12,color: Colors.black),)
                                      ],
                                    ),
                                  ],
                                ),
                                  ...
                                  child: Align(
                                    ...
                                    child: Row(
                                      children: [
                                        ...
                                        Text('|',style: TextStyle(fontSize: 15,color: Color(0xff595959)),),
                                        Text(
                                          "19:00, Today",
                                          style: TextStyle(
                                            fontSize: 12,
