...
class EtfUpcomingEvents extends StatefulWidget {
  const EtfUpcomingEvents({Key? key}) : super(key: key);

  @override
  State<EtfUpcomingEvents> createState() => _EtfUpcomingEventsState();
}

class _EtfUpcomingEventsState extends State<EtfUpcomingEvents>
        ...
        child: Column(
          ...
          children: [
            ...
            Expanded(
              child: TabBarView(
                controller: tabController,
                children: [EconomicTab(), EarningsTab(), DividendTab(),],
              ),
            ),
            Center(
              child: TextButton(
