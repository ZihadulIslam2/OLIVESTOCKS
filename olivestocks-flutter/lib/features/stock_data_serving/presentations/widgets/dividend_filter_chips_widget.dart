...
class DividendFilterChipsWidget extends StatefulWidget {
  final Function(Map<String, String>)? onFiltersChanged;

  const DividendFilterChipsWidget({
    Key? key,
    this.onFiltersChanged,
  }) : super(key: key);

  @override
  State<DividendFilterChipsWidget> createState() => _DividendFilterChipsWidgetState();
}

class _DividendFilterChipsWidgetState extends State<DividendFilterChipsWidget> {
