...
class OliveStocksPortfolioUnderRadarNew extends StatefulWidget {
  const OliveStocksPortfolioUnderRadarNew({super.key});



  @override
  State<OliveStocksPortfolioUnderRadarNew> createState() =>
      _OliveStocksPortfolioUnderRadarNewState();
}

class _OliveStocksPortfolioUnderRadarNewState extends State<OliveStocksPortfolioUnderRadarNew> {
    ...
    return GetBuilder<AuthController>(builder: (authController){
      ...
      return Scaffold(
        appBar: AppBar(
          ...
          title: const Text("Olive Stocks Portfolio Under Radar"),
          actions: [],
        ),
        body: Column(
          children: [
