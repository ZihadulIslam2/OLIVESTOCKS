...
class DailyInsiderFilterChipsWidget extends StatefulWidget {
  final Function(Map<String, String>)? onFiltersChanged;

  const DailyInsiderFilterChipsWidget({
    super.key,
    this.onFiltersChanged,
  });

  @override
  State<DailyInsiderFilterChipsWidget> createState() => _DailyInsiderFilterChipsWidgetState();
}

class _DailyInsiderFilterChipsWidgetState extends State<DailyInsiderFilterChipsWidget> {
