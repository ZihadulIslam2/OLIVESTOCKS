...
class ResearchFirmsTab extends StatefulWidget {
  final String title;
  const ResearchFirmsTab({super.key, required this.title});

  @override
  State<ResearchFirmsTab> createState() => _ResearchFirmsTabState();
}

class _ResearchFirmsTabState extends State<ResearchFirmsTab> {
  int selectedSortTab = 5;
  final sortTabs = ["Firm", "Average Return", "Success Rate",];
  @override
