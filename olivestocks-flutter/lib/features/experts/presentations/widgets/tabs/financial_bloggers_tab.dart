...
class FinancialBloggersTab extends StatefulWidget {
  final String title;
  const FinancialBloggersTab({super.key, required this.title});

  @override
  State<FinancialBloggersTab> createState() => _FinancialBloggersTabState();
}

class _FinancialBloggersTabState extends State<FinancialBloggersTab> {
  int selectedSortTab = 3;
  final sortTabs = ["Blogger", "Average Return", "Success Rate"];
